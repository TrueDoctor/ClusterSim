...

{
	...
	tempV = p + 9.5 * kav - 72.0 / 7.0 * kbv + 25.0 / 14.0 * kcv + 44.0 / 125.0 * ffv;
	...
	p = 5.0 / 48.0 * kap + 27.0 / 56.0 * kbp + 125.0 / 336.0 * kcp + 1.0 / 24.0 * kdp;
	v = 5.0 / 48.0 * kav + 27.0 / 56.0 * kbv + 125.0 / 336.0 * kcv + 1.0 / 24.0 * kdv;
